module NestedForm
  module BuilderMixin
    ...
    def link_to_add(*args, &block)
      ...
      options["data-blueprint-id"] = fields_blueprint_id = options[:blueprint] || fields_blueprint_id_for(association)
    ...
    def fields_for_with_nested_attributes(association_name, *args)
      ...
      @fields ||= {}
      @fields[options[:blueprint] || fields_blueprint_id_for(association_name)] = { :block => block, :options => options }
